...
const AllAdsCard = ({ onClick, item, onAction, onActionTouch }) => {
  ...
  const getStatus = () => {
    ...
    if ("rtcl-expired" === item?.status) {
      return __("listingStatus.rtcl-expired", appSettings.lng);
    }
    ...
    if ("rtcl-reviewed" === item?.status) {
      return __("listingStatus.rtcl-reviewed", appSettings.lng);
    }
  };
