    ...
    api.get("listing/form", { category_id: catId }).then((res) => {
      if (res.ok) {
        ...
        if (config?.booking && res?.data?.config?.booking) {
          ...
          autoUpdateBookingType(res.data.config.booking.type);
        }
...
`;
  ...
  const autoUpdateBookingType = (type) => {
              ...
              <View style={styles.bHWrap}>
                <View style={styles.contactTitleWrap}>
                  <Text style={[styles.title, rtlTextA]}>
                    {__("listingFormTexts.bookingTitle", appSettings.lng)}
                  </Text>
                </View>
                <AppSeparator style={styles.separator} />
                <View style={styles.bHContentWrap}>
                  <TouchableOpacity
                    ...
                    onPress={() =>
                      handleBookingDataChange(
                        ...
                        bookingData[bookingForm.active.name] ? false : true
                      )
                    }
                  >
                    <MaterialCommunityIcons
                  ...
                  {bookingData[bookingForm.active.name] && (
                    <>
                      <View style={[styles.bookingTypeWrap, rtlView]}>
                        <View style={styles.bookingTypeTitleWrap}>
                          <Text style={[styles.bookingTypeTitle, rtlText]}>
                        ...
                        >
                          {Object.keys(bookingForm.type.options).map(
                            (_btype, index) => {
                              if (config.booking[_btype].disable === false) {
                                return (
                                  <Pressable
                                    key={`${index}`}
                                  ...
                                  >
                                    ...
                                    <Text style={styles.radioOptionText}>
                                      {bookingForm?.type?.options[_btype] ||
                                        __(
                      ...
                      <View style={styles.bHs}>
                        {bookingForm?.fee && (
                          <View style={[styles.bHDayWrap, rtlView]}>
                            ...
                            >
                              <Text style={[styles.bHDayName, rtlText]}>
                            ...
                            >
                              <TextInput
                                ...
                                value={bookingData[bookingForm.fee.name] || ""}
                        ...
                        {!!bookingData[bookingForm.type.name] &&
                          Object.keys(bookingForm[bookingType]).map(
                            (_bookingField, index) => {
                              var bookingField =
                                bookingForm[bookingType][_bookingField];
                              var bookingFieldType = bookingField.type;
                              if (bookingFieldType === "custom") {
                                return (
                                  <View
                                    style={[{ marginVertical: 10 }, rtlView]}
                                    key={`${index}`}
                                  >
                                    <View
                                      style={{
                                  ...
                                  >
                                    ...
                                    >
                                      {[
                                        ...
                                        "url",
                                        "number",
                                      ].includes(bookingFieldType) && (
                                        <TextInput
                                          style={[
                                            bookingFieldType === "textarea"
                                              ? styles.metaField_TextArea
                                              : styles.metaField_Text,
                                            rtlTextA,
                                            {
                        ...
                        {bookingForm?.instant_booking && (
                          <>
                            <View style={[styles.bHDayWrap, rtlView]}>
                              ...
                              >
                                <Text style={[styles.bHDayName, rtlText]}>
                                  {bookingForm.instant_booking.label || ""}
                                </Text>
                              </View>
                              <View
                                style={{
                              ...
                              >
                                <TouchableOpacity
                                  ...
                                  onPress={() =>
                                    handleBookingDataChange(
                                      bookingForm.instant_booking.name,
                                      bookingData[
                                        bookingForm.instant_booking.name
                                      ]
                                        ? false
