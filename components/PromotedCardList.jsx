...
const PromotedCardList = ({ onPress, item, top_shown, featured_shown }) => {
              ...
              config?.badges?.bump_up?.listing && (
                <View
                  style={[
                    ...
                    rtl_support
                      ? { left: 0, borderBottomRightRadius: 3 }
                      : { right: 0, borderBottomLeftRadius: 3 },
                  ]}
                >
                  <FontAwesome
                    name="clock-o"
...
export default PromotedCardList;
