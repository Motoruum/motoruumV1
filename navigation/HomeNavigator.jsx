...
import AdminNoteScreen from "../screens/AdminNoteScreen";
import PromotedScreen from "../screens/PromotedScreen";
      ...
      >
        ...
        <Stack.Screen
          ...
          options={({ route }) => ({
            ...
            headerShown: !route?.params?.hidden,
            gestureEnabled: !route?.params?.hidden,
          })}
        />
        <Stack.Screen
        ...
        />
        <Stack.Screen
          name={routes.adminFeaturesScreen}
          component={AdminFeaturesScreen}
          options={{
            title: __("screenTitles.adminFeaturesScreen", appSettings.lng),
          }}
        />
        <Stack.Screen
          name={routes.allListingsSCreen}
          component={AllListingsScreen}
          options={{
            title: __("screenTitles.allListingsSCreen", appSettings.lng),
          }}
        />
        <Stack.Screen
          name={routes.allPaymentsSCreen}
          component={AllPaymentsScreen}
          options={{
            title: __("screenTitles.allPaymentsSCreen", appSettings.lng),
          }}
        />
        <Stack.Screen
        ...
        <Stack.Screen
          ...
          options={{
            title: __("screenTitles.bookingScreen", appSettings.lng),
            // headerShown: false,
          }}
        />
        <Stack.Screen
          name={routes.myBookingsScreen}
          component={MyBookingsScreen}
          options={{
            title: __("screenTitles.myBookingsScreen", appSettings.lng),
            // headerShown: false,
          }}
        />
        <Stack.Screen
          name={routes.allBookingsScreen}
          component={AllBookingsScreen}
          options={{
            title: __("screenTitles.allBookingsScreen", appSettings.lng),
            // headerShown: false,
          }}
        />
        <Stack.Screen
          name={routes.adminNoteScreen}
          component={AdminNoteScreen}
          options={{
            title: __("screenTitles.adminNoteScreen", appSettings.lng),
            // headerShown: false,
          }}
        />
        <Stack.Screen
          name={routes.promotedScreen}
